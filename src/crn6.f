...
C     NPAR=2 FOR MESON PI-0
      ...
      L1=LP-1+LI 
C     !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
C     POSSIBLE ERROR IN THE LINE BELOW: index L1 may go beyond index bounds declared for the array IENER
C     Array index bound check should be disabled in intel fortran compiler
      EE(LI)=IENER(L1,JS)
      DO 30 K=1,NEL(IN)
...
C
      ...
      OPEN(2,FILE='tables/barpol.dat',STATUS='OLD',FORM='FORMATTED')
